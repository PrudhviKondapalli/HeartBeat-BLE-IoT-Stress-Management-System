...
GATT_DATA(const uint8_t gattdb_uuidtable_128_map[]) =
{
  ...
  0x0c, 0x38, 0xc6, 0xbd, 0x15, 0xd6, 0xaf, 0x98, 0x5a, 0x46, 0xe3, 0xdd, 0x30, 0x1d, 0xfc, 0x62, 
  0xc4, 0xa9, 0x2a, 0xbe, 0x3a, 0xb3, 0x39, 0x9b, 0x16, 0x41, 0x03, 0xbd, 0xf2, 0x7d, 0x42, 0xaa, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_39) = {
  .len = 16,
  .data = { 0x28, 0x8f, 0x98, 0x7b, 0xb5, 0xa2, 0x57, 0x9b, 0xb1, 0x4a, 0x4e, 0x18, 0x8a, 0x97, 0x79, 0xbd, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_34) = {
  .len = 16,
  .data = { 0xe5, 0xf5, 0x1f, 0x03, 0x62, 0x71, 0x17, 0x86, 0x61, 0x4e, 0x3c, 0x05, 0xc8, 0x6e, 0x25, 0x10, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 7,
  .data = { 0x53, 0x6f, 0x6e, 0x61, 0x6c, 0x42, 0x4c, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x26, .uuid = 0x000c, .permissions = 0xc03, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x02, .clientconfig_index = 0x04 } },
  { .handle = 0x27, .uuid = 0x000d, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_38 },
  ...
  { .handle = 0x2b, .uuid = 0x000c, .permissions = 0xc03, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x02, .clientconfig_index = 0x05 } },
